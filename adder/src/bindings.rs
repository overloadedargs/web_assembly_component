    ...
    pub mod docs {
        ...
        pub mod adder {
            ...
            pub mod add {
                ...
                pub unsafe fn _export_add_cabi<T: Guest>(arg0: f32, arg1: f32) -> f32 {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
        ...
        ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
          ...
          unsafe extern "C" fn export_add(arg0: f32,arg1: f32,) -> f32 {
...
B\x02\x01@\x02\x01av\x01bv\0v\x04\0\x03add\x01\0\x04\x01\x14docs:adder/add@0.1.0\
